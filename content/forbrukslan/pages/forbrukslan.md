...
![Sammenlign og finn det billigste forbrukslånet](/forbrukslan/img/forbrukslan.webp "Billigste forbrukslån")
...
[Les alt om refinansiering her](https://www.dagbladet.no/refinansiering/)
...
<accordion>
<template #question> Hvem kan søke forbrukslån?</template>
<template #answer>
<p>
Det finnes flere krav du må oppfylle for å få innvilget et forbrukslån. Du må minst være 18 år gammel, vært norsk statsborger i minst tre år og ha en skattbar inntekt de siste årene. Du må samtidig bestå en kredittsjekk og ikke ha noen betalingsanmerkninger eller pågående inkassosaker.
</p>
</template>
</accordion>

<accordion>
<template #question> Hvor raskt får man svar på en søknad?</template>
<template #answer>
<p>
Normalt sett vil du få en tilbakemelding på din søknad innen 24 timer. </p>
</template>
</accordion>

<accordion>
<template #question> Hvor raskt vil pengene komme inn på konto?</template>
<template #answer>
<p>
Når en søknad har blitt godkjent vil det gå mellom 1-3 bankdager før pengene er utbetalt til din konto etter at du har signert tilbudet du har fått. </p>
</template>
</accordion>

<accordion>
<template #question> Hvordan tilbakebetaler man et forbrukslån?</template>
<template #answer>
<p>
Du betaler tilbake i henhold til tilbakebetalingsplanen eller tiden du har valgt. Hvis du ønsker kan du velge å tilbakebetale hele lånet når det passer deg hvis du ønsker det. </p>
</template>
</accordion>
